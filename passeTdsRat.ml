...
let analyse_tds_expression tds e = 
  match e with
    | AstSyntax.AppelFonction(s,expl) -> failwith "TO DO AppelFonction"
    | AstSyntax.Ident s -> failwith "TO DO Ident"
    | AstSyntax.Booleen b -> failwith "TO DO Booleen"
    | AstSyntax.Entier i -> failwith "TO DO Entier"
    | AstSyntax.Unaire (op, exp) -> failwith "TO DO Unaire"
    | AstSyntax.Binaire (op,exp1,exp2) -> failwith "TO DO Binaire"
